...
<form action="reporte.php" class="reporte-form validate-form" id="formfechas" name="formfechas" method="post" autocomplete="off">
    <div class="container-reporte">
        <div class="wrap-reporte">
        <span class="reporte-form-title">Cierre de Caja</span>
