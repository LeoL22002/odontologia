...
<center><h3>CONSULTA DE DIRECCIONES</h3></center>
<hr class="divider">
            ...
            <tbody class="text-center">
                    ...
                    $desde = ($pagina-1) * $por_pagina;
                     $total_paginas = ceil($total_registro/$por_pagina);
                        ...
                        INNER JOIN provincia AS p ON d.provincia= p.id_prov INNER JOIN pais AS pa ON p.pais = pa.id_pais ORDER BY d.id_dir ASC LIMIT $desde, $por_pagina ";
