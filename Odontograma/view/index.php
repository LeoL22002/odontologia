...
$sql = "SELECT pac.id_pac as id,CONCAT(per.nom_per,' ',ape.apellido) as Pacientes from persona per INNER JOIN paciente pac ON pac.id_per=per.id_per inner join apellidos as ape ON ape.id_ape=per.ape_per;";
...
<body>
	<header>
		...
		<a href="../../principal/menu.php"><button type="button" class="btn btn-info">VOLVER</button></a>
		<br>
		<br>
		...
		<section id="seccionRegistrarTratamiento" class="textAlignLeft sombraFormulario" style="background-color: white;padding: 20px;width: 1295px;">
			...
			<section class="displayInlineBlockMiddle">
				<form class="formulario sombraFormulario labelPequenio" style="text-align: left;">
					...
					<select id="txtCodigoPaciente" name="txtCodigoPaciente class="form-control" required="" >
...
<input type="hidden" id="txtCodigoPaciente" name="txtCodigoPaciente2" value="PACIENTE0000001">
			...
			<section class="displayInlineBlockTop textAlignCenter" style="margin-left: 10px;width: 230px;">
				<div id="divTratamiento" class="displayInlineBlockTop sombraFormulario" style="width: 525px;height:150px;overflow-y: scroll;">
				...
				<div class="displayInlineBlockTop">
					...
					<br>
					<textarea name="txtDescripcion" id="txtDescripcion" rows="3" cols="60" class="textArea"></textarea>
				</div>
			</section>
			<hr>
			<div>
