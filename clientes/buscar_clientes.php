...
<hr class="divider">
        ...
        <form action="buscar_clientes.php" class="buscador" method="get" >
                ...
                <table id="tablaclieados" class="table mt-2 table-bordered table-striped">
            <thead>
            ...
            <tbody>
                    <?php 
                        ...
                        $query = "
SELECT st.des_status Estado, ent.id_ent,d.num_docu, t.tip_docu, tl.n_telf, dr.id_dir, CONCAT(c.nom_calle,', ', m.nom_mun) Direccion
                        ...
                        on c.id_mun = m.id_mun inner join estados st on ent.status=st.id_status inner join email on dt.email=email.id_email WHERE cli.idcli LIKE '%$busqueda%' OR ent.nom_ent LIKE '%$busqueda%'";
...
<input type="hidden" value="1" name="band_cons">
            <div class="mb-3">
